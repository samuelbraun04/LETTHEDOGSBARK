...
const mockProducts = [
    { id: 1, name: 'Dog-Walker', price: 50, drop: 'Doggers Drop', photo: './src/assets/1hmgoepprod (1).webp', color: 'Red', discontinued: '2023-06-01' },
    { id: 2, name: 'Hound Hammers', price: 75, drop: 'Doggers Drop', photo: './src/assets/2hmgoepprod (1).webp', color: 'Blue', discontinued: '2023-06-10' },
    { id: 3, name: 'Paws & Play', price: 30, drop: 'Ruff Riders Drop', photo: './src/assets/3hmgoepprod (1).webp', color: 'Green', discontinued: '2023-06-20' },
    { id: 4, name: 'Bark & Lounge', price: 100, drop: 'Husking Drop', photo: './src/assets/4hmgoepprod (1).webp', color: 'Yellow', discontinued: '2023-06-15' },
];
