...
const mockProducts = [
  { id: 1, name: 'Canine Comfort', price: 50, drop: 'Doggers Drop', photo: './src/assets/167hmgoepprod (2).jpg', color: 'Red', discontinued: '2023-06-01' },
  { id: 2, name: 'Barking Bliss', price: 75, drop: 'Doggers Drop', photo: './src/assets/7654hmgoepprod (2).jpg', color: 'Blue', discontinued: '2023-06-10' },
  { id: 3, name: 'Tail-Wagger', price: 30, drop: 'Ruff Riders Drop', photo: './src/assets/3hmgoepprod (2).jpg', color: 'Green', discontinued: '2023-06-20' },
  { id: 4, name: 'Puppy Hate', price: 100, drop: 'Husking Drop', photo: './src/assets/5 hmgoepprod (2).jpg', color: 'Yellow', discontinued: '2023-06-15' },
];
