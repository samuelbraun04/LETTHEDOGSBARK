...
const mockProducts = [
  { id: 1, name: 'Barking Basic', description: "White shirt with red and blue vertical stripes.", price: 50, drop: 'Doggers Drop', photo: './src/assets/1hmgoepprod.jpg', sleeve: 'Shortsleeve', color: 'White', discontinued: '2023-06-01' },
  ...
  { id: 3, name: 'K9 Couture', description: "Simple black shirt with one button.", price: 30, drop: 'Ruff Riders Drop', photo: './src/assets/3 hmgoepprod (2).jpg', sleeve: 'Shortsleeve', color: 'Black', discontinued: '2023-06-20' },
  ...
  { id: 5, name: 'Canine Comfort', description: "Cream rugby-type shirt with two buttons down the middle.", price: 50, drop: 'Doggers Drop', photo: './src/assets/3637hmgoepprod.jpg', sleeve: 'Longsleeve', color: 'Cream', discontinued: '2023-06-01' },
  ...
  { id: 7, name: 'Hound\'s Tooth', description: "Dark blue shirt with yellow text on the left side of the chest saying Cascade Range Mountain Rescue Department.", price: 30, drop: 'Ruff Riders Drop', photo: './src/assets/7hmgoepprod (2).jpg', sleeve: 'Shortsleeve', color: 'Blue', discontinued: '2023-06-20' },
